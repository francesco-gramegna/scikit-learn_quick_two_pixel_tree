...
cdef inline int node_split_two_pixels(
    ...
    while (f_i > n_total_constants and  # Stop early if remaining features
        ...
        if f_i - n_found_constants < n_drawn_constants + 2:
             # Stop the loop if we can't draw two unique non-constant features
             break
    ...
    if best_split.pos < end:
        ...
        partitioner.partition_samples_final_two_pixel(
            best_split.pos,
